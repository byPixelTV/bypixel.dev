        ...
        <div className="w-full max-w-md space-y-4">
          ...
          <Card className="w-full bg-white/10 backdrop-blur-md border-white/20 shadow-xl">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-white/80">Sign in or create an account using your Discord account</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="bg-white/10 backdrop-blur-md px-2 text-xs text-white/80 rounded">Quick & Secure</span>
                </div>
              </div>
